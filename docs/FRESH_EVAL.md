...
Note on 2026-09-16: its B1 comes from the prior available session 2026-09-04, a 12-day gap, because the sessions between the last stored session and the lock date were imported only afterwards (Research Plan Amendment 9); the session stands as scored.
