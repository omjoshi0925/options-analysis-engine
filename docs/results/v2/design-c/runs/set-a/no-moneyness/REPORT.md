...
| Quantity | Value |
|---|---:|
| Model win rate (session loss) | 0.390 |
| Mean loss differential (baseline - model) | 4.643e-04 |
| Diebold-Mariano statistic (HLN) | 3.583 |
| Two-sided p-value | 0.0003555 |
| DM with Newey-West HAC (15 lags) | 1.194 (p = 0.2326) |
| Lag-1 autocorrelation of the differential | 0.875 |
| Bootstrap 95% CI for the differential | [-1.016e-06, 1.246e-03] |
