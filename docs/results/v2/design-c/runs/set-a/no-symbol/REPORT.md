...
| Quantity | Value |
|---|---:|
| Model win rate (session loss) | 0.626 |
| Mean loss differential (baseline - model) | 4.724e-04 |
| Diebold-Mariano statistic (HLN) | 3.646 |
| Two-sided p-value | 0.0002788 |
| DM with Newey-West HAC (15 lags) | 1.216 (p = 0.2243) |
| Lag-1 autocorrelation of the differential | 0.875 |
| Bootstrap 95% CI for the differential | [6.979e-06, 1.251e-03] |
