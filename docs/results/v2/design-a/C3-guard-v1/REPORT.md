...
| Quantity | Value |
|---|---:|
| Model win rate (session loss) | 0.644 |
| Mean loss differential (baseline - model) | 4.755e-04 |
| Diebold-Mariano statistic (HLN) | 3.668 |
| Two-sided p-value | 0.0002571 |
| DM with Newey-West HAC (15 lags) | 1.223 (p = 0.2217) |
| Lag-1 autocorrelation of the differential | 0.875 |
| Bootstrap 95% CI for the differential | [9.624e-06, 1.256e-03] |
