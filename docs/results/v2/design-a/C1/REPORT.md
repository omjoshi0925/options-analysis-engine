...
| Quantity | Value |
|---|---:|
| Model win rate (session loss) | 0.637 |
| Mean loss differential (baseline - model) | 4.742e-04 |
| Diebold-Mariano statistic (HLN) | 3.657 |
| Two-sided p-value | 0.0002678 |
| DM with Newey-West HAC (15 lags) | 1.219 (p = 0.223) |
| Lag-1 autocorrelation of the differential | 0.874 |
| Bootstrap 95% CI for the differential | [8.399e-06, 1.254e-03] |
