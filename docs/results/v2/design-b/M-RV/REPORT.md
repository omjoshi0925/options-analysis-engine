...
| Quantity | Value |
|---|---:|
| Model win rate (session loss) | 0.708 |
| Mean loss differential (baseline - model) | 2.530e-04 |
| Diebold-Mariano statistic (HLN) | 2.114 |
| Two-sided p-value | 0.03478 |
| DM with Newey-West HAC (15 lags) | 1.114 (p = 0.2653) |
| Lag-1 autocorrelation of the differential | 0.713 |
| Bootstrap 95% CI for the differential | [1.026e-05, 8.007e-04] |
